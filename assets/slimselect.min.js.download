...
new SlimSelect({
  ...
  settings: {
    alwaysOpen: false,
    showSearch: true,
    searchPlaceholder: 'Search by categories',
    searchText: 'There are no such categories',
    searchingText: 'Searching...',
    searchHighlight: false,
    closeOnSelect: true,
    contentPosition: 'absolute',
    openPosition: 'auto', // options: auto, up, down
    placeholderText: 'Select one or two categories...',
    allowDeselect: false,
    hideSelected: false,
    minSelected: 0,
    maxSelected: 2,
...
new SlimSelect({
  ...
  settings: {
    ...
    searchText: 'Таких категорий нет',
 ...
 /* CUSTOM COMMENTS ADMIN SELECT
  * ================== */
new SlimSelect({
  select: '.mass_comments_action > select',
  settings: {
    alwaysOpen: false,
    showSearch: false,
    searchHighlight: false,
